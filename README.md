...
// Urls
NETSUITE_LEAD_CREATION_RESTLET_URL="NETSUITE PRODUCTION RESTLET URL" // Callback RESTlet URL
NETSUITE_ADD_FILE_ATTACHMENTS_RESTLET_URL="NETSUITE PRODUCTION RESTLET URL" // Callback RESTlet URL
NETSUITE_CASE_CREATION_RESTLET_URL="NETSUITE PRODUCTION RESTLET URL" // Callback RESTlet URL
NETSUITE_CUSTOMER_SEARCH_RESTLET_URL="NETSUITE PRODUCTION RESTLET URL" // Callback RESTlet URL
```
...
#### Get Customer By Field Name
/customer

[Customer Record - Field Names](https://www.netsuite.com/help/helpcenter/en_US/srbrowser/Browser2017_2/script/record/customer.html)
